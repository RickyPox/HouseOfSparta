      ...
      <div className='2xl:px-[300px] lg:px-[160px] px-[20px] pt-[100px] flex flex-col lg:flex-row lg:justify-between lg:items-start justify-center items-center' id="HouseSparta">    
          ...
          <div className='lg:w-3/6 z-10'  >
            ...
            <ScrollAnimation animateOnce animateIn="animate__fadeIn">
              <p className=' text-[18px] text-white leading-[30px] mt-[40px]'>
              ...
              {/* <div className="mt-[60px]">
                <a href='#' className='md:py-[25px] md:px-[60px] px-[30px] py-[10px] rounded-[15px] bg-black/70 hover:bg-black/90 text-white  font-regular text-[24px]'>View Litepaper</a>
              </div> */}
            </ScrollAnimation>
          </div>
        <div className='z-10'>
